...
export default function FinanceLayout({ children }: FinanceLayoutProps) {
    ...
    const navigation = [
        ...
        { name: 'Payouts', href: '/dashboard/finance/payouts', icon: DollarSign },
        { name: 'Invoices', href: '/dashboard/finance/invoices', icon: FileText },
        { name: 'Escrow', href: '/dashboard/finance/escrow', icon: CreditCard },
    ];
                ...
                <header className="relative z-10 h-16 bg-slate-900/30 backdrop-blur-xl border-b border-slate-800/50 flex items-center justify-between px-6">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right">
                            <p className="text-sm font-medium text-white">Financial Controller</p>
                            <p className="text-xs text-slate-400">finance@recruitkart.com</p>
                        </div>
