...
import { ArrowLeft, Mail, Phone, MapPin, Briefcase, GraduationCap, Calendar, Download, CheckCircle, XCircle, Clock, Loader2 } from 'lucide-react';
            ...
            <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col items-end gap-3">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button className="px-4 py-2 bg-rose-500 hover:bg-rose-600 text-white rounded-lg transition-colors">
                            Schedule Interview
                        </button>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800/50">
                        ...
                        <button className="w-full mt-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg transition-colors text-sm">
                            View Full Timeline
                        </button>
                    </div>
                </div>
