...
import { Search, Filter, MoreVertical, FileText, Mail, Phone, Briefcase, Loader2, Users } from 'lucide-react';
        ...
        <div className="p-8 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400">Review and manage applications for your open roles.</p>
                </div>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-slate-800">
                                <div className="flex flex-col">
                                    <span className={`px-2 py-1 rounded-full text-xs font-medium w-fit mb-1 ${candidate.status === 'HIRED' ? 'bg-emerald-500/10 text-emerald-500' :
                                            candidate.status === 'INTERVIEWING' ? 'bg-amber-500/10 text-amber-500' :
                                                'bg-slate-500/10 text-slate-500'
                                        }`}>
                                        {candidate.status}
                                    </span>
                                    <span className="text-xs text-slate-500">Stage: {candidate.stage}</span>
                                </div>
                                <button className="text-rose-500 hover:text-rose-400 text-sm font-medium flex items-center gap-1">
