...
export default function SupportDashboard() {
    const stats = [
        { name: 'Open Tickets', value: '12', icon: Ticket, color: 'text-blue-500', bg: 'bg-blue-500/10' },
        { name: 'In Progress', value: '5', icon: Clock, color: 'text-yellow-500', bg: 'bg-yellow-500/10' },
        { name: 'Resolved Today', value: '8', icon: CheckCircle, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
        { name: 'Urgent', value: '3', icon: AlertCircle, color: 'text-red-500', bg: 'bg-red-500/10' },
    ];
