...
export default function ResetMemberPasswordModal({ isOpen, onClose, userId, userEmail }: ResetMemberPasswordModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/company/team/reset-password', {
                method: 'POST',
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-slate-400 mt-1">For {userEmail}</p>
                            </div>
